...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-ags4-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12890&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-ags4-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-ags4` can be installed with:

```
conda install python-ags4
```

It is possible to list all of the versions of `python-ags4` available on your platform with:
